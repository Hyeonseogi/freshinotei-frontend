...
const CameraScreen = ({ onCapture, onClose }) => {
  return (
    <div className="w-full max-w-[400px] h-screen mx-auto bg-[#1C1C1E] relative font-sans flex flex-col text-white">
      {/* 상단 헤더 */}
      ...
      <main className="flex-1 flex flex-col items-center px-6 mt-8">
        ...
        <div className="w-full bg-[#2C2C2E] rounded-xl p-4 flex items-center gap-3">
          <div className="bg-[#3A3A3C] p-2 rounded-full">
      ...
      <footer className="pb-12 pt-6 flex flex-col items-center gap-6 relative">
        <div className="flex items-center justify-center w-full px-12 relative">
          {/* 갤러리 버튼 */}
          <button className="absolute left-10 w-12 h-12 bg-[#2C2C2E] rounded-xl flex items-center justify-center text-gray-400">
